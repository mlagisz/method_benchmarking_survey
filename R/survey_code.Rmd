...
mydat %>%
  ggplot( aes(x = sum_sources, fill = Survey)) +
    ...
    facet_wrap(~ factor(Survey, levels = c("Cochrane", "other"), 
                  labels = c("Cochrane", "other")), ncol = 2)
...
#ggsave(plot = figure1, here("plots", "Fig_survey_results_v1.png"), width = 16, height = 19, units = "cm", dpi = "retina", scale = 1.8)
#ggsave(plot = figure1, here("plots", "Fig_survey_results_v1.pdf"), width = 16, height = 19, units = "cm", scale = 1.8)
```
